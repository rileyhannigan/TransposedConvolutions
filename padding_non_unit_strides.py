...
class PaddingNonUnitStrides(Scene):
   ...
   # creates padding 
    ...
    def construct(self):
        ...
        padding_text_trans3 = Text("p' = (3 - 1 - 1) x (3 - 1 - 1)", color=ORANGE).next_to(padding_text_trans1,DOWN*0.35).scale(0.7)
        ...
        input_squares_trans = self.create_squares(2, 2, 0.5, 1, YELLOW, 1.8, -3.1)
