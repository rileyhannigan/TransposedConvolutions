...
class PaddingUnitStrides(Scene):
   ...
   # creates padding 
    ...
    def construct(self):
        ...
        output_squares = self.create_squares(4, 5, 0.5, 1, PURPLE, -0.5, 3.2)
        ...
        input_text_trans = Text("Input: 4 x 5", color=PURPLE).shift(UP*3.1, LEFT*1).scale(0.7)
        ...
        input_squares_trans = self.create_squares(4, 5, 0.5, 1, PURPLE, 2.5, -2)
